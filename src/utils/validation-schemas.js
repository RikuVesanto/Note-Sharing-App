...
module.exports = {
  LoginValidationSchema: Yup.object().shape({
    email: Yup.string().required(i18n.t('email_validation')),
    password: Yup.string().required(i18n.t('password_validation')),
  }),
  RegisterValidationSchema: Yup.object().shape({
    ...
    username: Yup.string()
      .min(4, i18n.t('register_password_validation_short'))
      .max(32, i18n.t('register_password_validation_long'))
      .required(i18n.t('password_validation')),
    name: Yup.string(),
    school: Yup.string(),
  }),
